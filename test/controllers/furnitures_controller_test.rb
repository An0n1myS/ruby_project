...
class FurnituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create furniture" do
    assert_difference("Furniture.count") do
      post furnitures_url, params: { furniture: { content: @furniture.content, name: @furniture.name, price: @furniture.price, title: @furniture.title } }
    end
  ...
  test "should update furniture" do
    patch furniture_url(@furniture), params: { furniture: { content: @furniture.content, name: @furniture.name, price: @furniture.price, title: @furniture.title } }
